...
//
//  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
#define NormalColor  [UIColor yellowColor]
...
- (void)setupTitleArr {
    ...
    if (self.segmentedControlType == SGSegmentedControlTypeScroll) {
        ...
        for (NSUInteger i = 0; i < _title_Arr.count; i++) {
            ...
            [_title_btn setTitleColor:NormalColor forState:(UIControlStateNormal)];
            [_title_btn setTitleColor:SelectedColor forState:(UIControlStateSelected)];
...
- (void)setupImageAndTitleArr {
    ...
    if (self.segmentedControlType == SGSegmentedControlTypeScroll) {
        ...
        for (NSUInteger i = 0; i < _title_Arr.count; i++) {
            ...
            [_image_title_btn setTitleColor:NormalColor forState:(UIControlStateNormal)];
            [_image_title_btn setTitleColor:SelectedColor forState:(UIControlStateSelected)];
