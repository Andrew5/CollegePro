//
//  DHImagePickerViewController.m
//  Test
//
//  Created by Rillakkuma on 2017/8/25.
//  Copyright © 2017年 Rillakkuma. All rights reserved.
//

#import "DHImagePickerViewController.h"
...
@interface DHImagePickerViewController ()<TZImagePickerControllerDelegate,UICollectionViewDataSource,UICollectionViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UIAlertViewDelegate,UINavigationControllerDelegate> {
...
@implementation DHImagePickerViewController
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
	...
	if (indexPath.row == _selectedPhotos.count) {
		cell.imageView.image = [UIImage imageNamed:@"AlbumAddBtn.imageset"];
